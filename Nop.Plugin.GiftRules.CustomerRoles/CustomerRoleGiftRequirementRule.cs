...
{
    public partial class CustomerRoleGiftRequirementRule : BasePlugin, IGiftRequirementRule
    {
        #region Fields
        ...
        public CustomerRoleGiftRequirementRule(IActionContextAccessor actionContextAccessor,
        ...
        /// </returns>
    public async Task<GiftRequirementValidationResult> CheckRequirementAsync(GiftRequirementValidationRequest request)
        {
            if (request == null)
                throw new ArgumentNullException(nameof(request));

            //invalid by default
            var result = new GiftRequirementValidationResult();

            if (request.Customer == null)
                return result;

            //try to get saved restricted customer role identifier
            var restrictedRoleId = await _settingService.GetSettingByKeyAsync<int>(string.Format(GiftRequirementDefaults.SettingsKey, request.GiftRequirementId));
        ...
        public override async Task UninstallAsync()
        {
            ...
            var discountRequirements = (await _discountService.GetAllDiscountRequirementsAsync())
                .Where(discountRequirement => discountRequirement.DiscountRequirementRuleSystemName == GiftRequirementDefaults.SystemName);
